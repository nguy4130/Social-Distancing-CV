...
def main(dataset, data_time, detector):
    ...
    transform_cam2world = np.loadtxt('calibration/oxford_town_matrix_cam2world.txt')

    # open video of dataset
    if dataset == 'oxford_town':
        cap = cv2.VideoCapture(os.path.join('datasets/datasets', 'TownCentreXVID.avi'))
    ...
    while cap.isOpened():
        try:
          ...
          if vis:
              ...
              cv2.imwrite('Img_29_test.png', img)
          ...
          print('Number of people count: %d' % count)
          print('=======================')
          i_frame += 1
        except:
...
if __name__ == '__main__':
    ...
    datasets = ['tinyImg2']
    # datasets = ['tinyImg1', 'tinyImg2', 'redoImg1', 'redoImg2']
